...
export const sendReminderEmail = async (invoice: Invoice) => {
  ...
  const subject = `Payment Reminder: Invoice #${invoice.invoiceNumber ?? invoice.id} from ${invoice.fromName}`;
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
      <tr>
        <td style="padding:24px 24px 8px 24px;background:#0f172a;color:#ffffff;">
          ...
          <div style="font-size:12px;opacity:0.8;">Friendly payment reminder</div>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:24px;">
          <div style="margin-bottom:24px;padding:16px;background:#fef3c7;border-left:4px solid #f59e0b;border-radius:8px;">
            <div style="font-size:14px;font-weight:600;color:#92400e;margin-bottom:4px;">Payment Reminder</div>
            <div style="font-size:13px;color:#78350f;">This is a friendly reminder that the following invoice is still pending payment.</div>
          </div>
          ...
          <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;">
            ...
            <div style="text-align:right;">
              ...
              <div style="font-size:14px;font-weight:500;color:${dueOn < new Date() ? "#dc2626" : "#111827"};">
